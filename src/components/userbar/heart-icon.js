    ...
    <div className='cart-icon'>
      <svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="#1B1A17" stroke="#1B1A17" strokeWidth="0.75"/>
      </svg>
        <CSSTransition
          in={favoritesCartIsNotEmpty}
          timeout={500}
          classNames='cart-icon__badge'
          >
          {
            favoritesCartIsNotEmpty
              ? <div className='cart-icon__badge cart-icon__badge_brown'>{favorites.length}</div>
              : <></>
          }
        </CSSTransition>
    </div>
